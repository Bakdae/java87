...
/* 옷장에담은스타일 */
 ...
 CREATE TABLE INTO_CLS (
	CL_NO INTEGER NOT NULL, /* 옷일련번호 */
	STYLE_NO INTEGER NOT NULL, /* 스타일련번호 */
	CLS_NO INTEGER NOT NULL /* 옷장일련번호 */
);

COMMENT ON TABLE INTO_CLS IS '옷장에담은스타일';

COMMENT ON COLUMN INTO_CLS.CL_NO IS '옷일련번호';

COMMENT ON COLUMN INTO_CLS.STYLE_NO IS '스타일련번호';

COMMENT ON COLUMN INTO_CLS.CLS_NO IS '옷장일련번호';
